...
反卷教练 6 个扣子日程 description 必须使用以下文件内容：
...
GOAL_CARD_DIR=/tmp/anti-coach-test python3 scripts/coze_schedule_runner.py 12:00
```
...
3. 反卷教练日程 description 只能来自 `templates/coze_schedules/`。
